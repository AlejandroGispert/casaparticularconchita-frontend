    ...
    <>
      <div className="Terms">
        <h2>
          ...
          <span className="website_url">www.alquilerdeconchitayalex.com</span>
        </h2>
        <p>
        ...
        <p>
          ...
          <span className="website_name">Alquiler de Conchita y Alex</span>,
          because by using the Website you accept and agree to be bound and
          abide by these Terms and Conditions.
        </p>
        <p>
          These Terms and Conditions are effective as of{" "}
          <span className="date">01.February.2022</span>. We expressly reserve
          the right to change these Terms and Conditions from time to time
          without notice to you. You acknowledge and agree that it is your
          responsibility to review this Website and these Terms and Conditions
          ...
          constitute acknowledgement of the modified Terms and Conditions and
          agreement to abide and be bound by the modified Terms and Conditions.
        </p>
        ...
        <p>
          ...
          <a href="https://www.termsconditionstemplate.net">
            Terms Conditions Template Generator
          </a>
          .
        </p>
        <p>
          By posting information in or otherwise using any communications
          service, chat room, message board, newsgroup, software library, or
          other interactive service that may be available to you on or through
          this Website, you agree that you will not upload, share, post, or
        ...
        <p>
          ...
          Terms of Use and any other rules of user conduct for our Website, or
          is otherwise harmful, objectionable, or inaccurate. We are not
          responsible for any failure or delay in removing such content. You
        ...
        <p>
          ...
          that all content presented to you on this Website is protected by
          copyrights, trademarks, service marks, patents or other proprietary
          rights and laws, and is the sole property of{" "}
          <span className="website_name">Alquiler de Conchita y Alex</span>.
        </p>
        <p>
          You are only permitted to use the content as expressly authorized by
          us or the specific content provider. Except for a single copy made for
          ...
          copyrighted material that is available on this Website.
        </p>
        ...
        <p>
          ...
          and/or services provided by other parties. These websites may contain
        ...
        <p>
          Your use of{" "}
          <span className="website_name">Alquiler de Conchita y Alex</span> is
        ...
        <p>
          ...
          when you create a{" "}
          <span className="website_name">Alquiler de Conchita y Alex</span>{" "}
          booking or when you start using the{" "}
          <span className="website_name">Alquiler de Conchita y Alex</span> and
          will remain effective until terminated by you or by us.
        </p>
        <p>
          <span className="website_name">Conchita y Alex</span> reserves the
          right to terminate this Terms and Conditions or suspend your booking
          at any time in case of unauthorized, or suspected unauthorized use of
          the Website whether in contravention of this Terms and Conditions or
          otherwise.If{" "}
          <span className="website_name">Alquiler de Conchita y Alex</span>{" "}
        ...
        <h3>Assignment</h3>
        <p>
          <span className="website_name">Alejandro Gispert</span> may assign
          this Terms and Conditions or any part of it without restrictions. You
          may not assign this Terms and Conditions or any part of it to any
          third party.
        </p>
        <h3>Governing Law</h3>
        <p>
          ...
          the internal laws of <span className="country">Cuba</span> without
          giving effect to any choice or conflict of law provision or rule.
        </p>
        <p>
          Any legal suit, action or proceeding arising out of, or related to,
          these Terms of Service or the Website shall be instituted exclusively
          in the courts of <span className="country">Cuba</span>.
        </p>
      </div>
      <Footer />
    </>
