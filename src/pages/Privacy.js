  ...
  return (
    <>
      <div className="Privacy">
        <h1>Privacy Policy for www.alquilerdeconchitayalex.com</h1>

        <p>
          At Alquiler de Conchita y Alex, accessible from
          www.alquilerdeconchitayalex.com, one of our main priorities is the
          privacy of our visitors. This Privacy Policy document contains types
          of information that is collected and recorded by Alquiler de Conchita
          y Alex and how we use it.
        </p>
        ...
        <p>
          www.alquilerdeconchitayalex.com legal basis for collecting and using
        ...
        <ul>
          <li>
            www.alquilerdeconchitayalex.com needs to perform a contract with you
          </li>
          <li>
            You have given www.alquilerdeconchitayalex.com permission to do so
          </li>
          <li>
            Processing your personal information is in
            www.alquilerdeconchitayalex.com legitimate interests
          </li>
          <li>www.alquilerdeconchitayalex.com needs to comply with the law</li>
        </ul>

        <p>
          www.alquilerdeconchitayalex.com will retain your personal information
        ...
        <p>
          Alquiler de Conchita y Alex follows a standard procedure of using log
        ...
        <p>
          ...
          advertising partners of Alquiler de Conchita y Alex.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Alquiler de Conchita y Alex,
        ...
        <p>
          Note that Alquiler de Conchita y Alex has no access to or control over
        ...
        <p>
          Alquiler de Conchita y Alex's Privacy Policy does not apply to other
        ...
        <p>
          Alquiler de Conchita y Alex does not knowingly collect any Personal
        ...
        <p>
          ...
          shared and/or collect in Alquiler de Conchita y Alex. This policy is
